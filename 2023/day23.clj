...
(let [Map (parse "./2023/in23")
      ...
      dict {[65 135] {[57 103] 185, [79 133] 77},
            ...
            [79 133] {[81 103] 149, [101 127] 165},
            [127 81] {[113 79] 41, [137 109] 211},
            [41 125] {[39 101] 111, [65 135] 215},
            ...
            [19 89] {[39 79] 119, [7 101] 129},
            [7 101] {[39 101] 233, [41 125] 575},
            [127 39] {[111 39] 109, [131 59] 165},
            [53 77] {[65 61] 105, [39 79] 57, [77 79] 107, [57 103] 187},
            [67 11] {[87 19] 177, [57 33] 121},
            ...
            [29 13] {[67 11] 285, [41 35] 183},
            [0 1] {[29 13] 235, [17 33] 335},
            [17 33] {[41 35] 115, [19 65] 327}}]
  (comment
    ;;    [[0 1] {[7 15] 130}]
  ...
  (let [bitmap (apply merge (for [k (keys dict)] {k false}))
    ...
    (loop [todo [[start 0 bitmap]]]
      (let [[[r c :as node] step bit] (first todo)
        ...
        (cond
          (= node [127 135]) (do (when (> step @biggest)
                                   (println step)
                                   (reset! biggest step))
                                 (recur (rest todo)))
          :else
